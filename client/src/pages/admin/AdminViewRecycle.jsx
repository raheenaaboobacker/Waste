        ...
        <div>
            ...
            <main className="hoc container clear" id='volrequest' style={{ marginTop: -150 }}>
                <Row>
                    ...
                    {arrOfData?.map(item => <>{item?.wasteData?.status == 2 ? <Card style={{
                        width: "300px", height: "160px", display: 'flex', marginLeft: "40px", marginTop: 50,
...
export default AdminViewRecycle